...
% Last Modified by GUIDE v2.5 16-Jul-2018 14:50:40
...
% handles    structure with handles and user data (see GUIDATA)
  ...
  getGridInflation = str2num(get(handles.getGridInflation, 'String'));
  map = get(handles.map, 'String');
  ratio = str2num(get(handles.ratio, 'String'));
  checkMove = str2num(get(handles.checkMove, 'String'));
  barMove = str2num(get(handles.barMove, 'String'));
  getDistTableInflation = str2num(get(handles.getDistTableInflation, 'String'));
...
% handles    structure with handles and user data (see GUIDATA)
  ...
  startPointX = str2num(get(handles.startPointX, 'String'));
  startPointY = str2num(get(handles.startPointY, 'String'));
  startPoint = [startPointX, startPointY];
  
  endPointX = str2num(get(handles.endPointX, 'String'));
  endPointY = str2num(get(handles.endPointY, 'String'));
  endPoint = [endPointX, endPointY];
  
  numWaypoints = str2num(get(handles.numWaypoints, 'String'));
  MaxIt = str2num(get(handles.MaxIt, 'String'));
  nPop = str2num(get(handles.nPop, 'String'));
  ...
  % Just an idea
  %set(handles.nPop, 'String', num2str(nPop));
